...
export interface ApiMembreEquipeMembreEquipe
  extends Struct.CollectionTypeSchema {
  collectionName: 'membre_equipes';
  info: {
    displayName: 'MembreEquipe';
    pluralName: 'membre-equipes';
    singularName: 'membre-equipe';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::membre-equipe.membre-equipe'
    >;
...
export interface ApiPublicationPublication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fichier: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    langue: Schema.Attribute.Enumeration<['FR', 'EN']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
